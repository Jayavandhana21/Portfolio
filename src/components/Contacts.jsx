...
const handleSubmit = async (e) => {
  ...
  if (!serviceID || !templateID) {
    ...
    Swal.fire({
      title: 'Config error',
      text: 'Email service or template ID is missing.',
      icon: 'error',
  ...
  console.error('EmailJS caught error (raw):', error);
  try {
  ...
  Swal.fire({
    ...
    // give a brief pause before clearing if you like
